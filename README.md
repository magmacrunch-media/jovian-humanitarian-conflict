...
| `wii/` | Wii version, on [magnolia](../../engines/magnolia). Complete against the browser -- rules, renderer, audio, scoreboard, attract mode -- at 60fps in Dolphin; not yet on real hardware. See `wii/README.md` |
