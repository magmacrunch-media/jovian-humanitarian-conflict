...
| `wii/` | Wii version, on [magnolia](../../engines/magnolia). Rules ported and tested, runs in Dolphin; the renderer is a placeholder and it has not been on real hardware. See `wii/README.md` |
