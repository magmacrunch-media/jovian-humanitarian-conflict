...
| `wii/` | Wii version, on [magnolia](../../engines/magnolia). Rules and renderer both ported, runs in Dolphin at 60fps; no audio yet, and it has not been on real hardware. See `wii/README.md` |
